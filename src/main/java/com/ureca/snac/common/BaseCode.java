...
public enum BaseCode {
    ...
    DISPUTE_EXTRA_REQUESTED("DISPUTE_EXTRA_REQUESTED_200", HttpStatus.OK,"추가 자료 요청을 보냈습니다."),
    DISPUTE_RESOLVE_SUCCESS("DISPUTE_RESOLVE_SUCCESS_200", HttpStatus.OK,"신고가 처리되었습니다."),
