...
public interface EmailControllerSwagger {
    ...
    ResponseEntity<ApiResponse<Void>> sendVerificationCode(@RequestBody EmailRequest dto);
    ...
    ResponseEntity<ApiResponse<Void>> verifyCode(@RequestBody VerificationEmailRequest dto);
}
